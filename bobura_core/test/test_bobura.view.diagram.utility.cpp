    ...
    BOOST_AUTO_TEST_SUITE(view)
        BOOST_AUTO_TEST_SUITE(diagram)
            ...
            BOOST_AUTO_TEST_CASE(time_to_left)
            {
                ...
                const auto result = bobura::view::diagram::time_to_left(
                    time_type{ 1 },
                    time_span_type{ 2 },
                    0,
            ...
            BOOST_AUTO_TEST_CASE(station_index_to_top)
            {
                ...
                const std::vector<position_unit_type> station_positions{ position_unit_type{},
                                                                         position_unit_type{ 42 } };

                const auto result = bobura::view::diagram::station_index_to_top(
                    station_positions,
                    size_type{ 1 },
