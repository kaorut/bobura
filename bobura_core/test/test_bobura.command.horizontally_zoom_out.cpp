/*! \file
    \brief Test of class bobura::command::horizontally_zoom_out.
...
namespace {
    ...
    using horizontally_zoom_out_command_type = bobura::command::horizontally_zoom_out<
...
BOOST_AUTO_TEST_SUITE(test_bobura)
    BOOST_AUTO_TEST_SUITE(command)
        BOOST_AUTO_TEST_SUITE(horizontally_zoom_out)
            // test cases
            ...
            BOOST_AUTO_TEST_CASE(construction)
            {
                ...
                const horizontally_zoom_out_command_type command{ diagram_view };
            }
