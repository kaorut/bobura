        ...
        BOOST_AUTO_TEST_SUITE(timetable)
            ...
            BOOST_AUTO_TEST_SUITE(line_name_header)
                ...
                BOOST_AUTO_TEST_CASE(construction)
                {
                    ...
                    line_name_header_type       header1{ string_type{ TETENGO2_TEXT("hoge") },
                                                   font_type::dialog_font(),
                                                   color_type{ 12, 34, 56 },
                                                   position_type{ position_unit_type{ 42 }, position_unit_type{ 24 } },
                ...
                BOOST_AUTO_TEST_CASE(operator_assign)
                {
                    ...
                    line_name_header_type header1{ string_type{ TETENGO2_TEXT("hoge") },
                                                   ...
                                                   dimension_type{ dimension_unit_type{ 24 },
                                                                   dimension_unit_type{ 42 } } };
                    line_name_header_type header2{ string_type{ TETENGO2_TEXT("hoge") },
                                                   font_type::dialog_font(),
                                                   color_type{ 12, 34, 56 },
                                                   position_type{ position_unit_type{ 42 }, position_unit_type{ 24 } },
                                                   dimension_type{ dimension_unit_type{ 24 },
            ...
            BOOST_AUTO_TEST_SUITE(note_header)
                ...
                BOOST_AUTO_TEST_CASE(construction)
                {
                    ...
                    note_header_type       header1{ string_type{ TETENGO2_TEXT("hoge") },
                                              font_type::dialog_font(),
                                              color_type{ 12, 34, 56 },
                                              position_type{ position_unit_type{ 42 }, position_unit_type{ 24 } },
                                              dimension_type{ dimension_unit_type{ 24 }, dimension_unit_type{ 42 } } };
                ...
                BOOST_AUTO_TEST_CASE(operator_assign)
                {
                    ...
                    note_header_type header1{ string_type{ TETENGO2_TEXT("hoge") },
                                              ...
                                              position_type{ position_unit_type{ 42 }, position_unit_type{ 24 } },
                                              dimension_type{ dimension_unit_type{ 24 }, dimension_unit_type{ 42 } } };
                    note_header_type header2{ string_type{ TETENGO2_TEXT("hoge") },
                                              font_type::dialog_font(),
                                              color_type{ 12, 34, 56 },
                                              position_type{ position_unit_type{ 42 }, position_unit_type{ 24 } },
                                              dimension_type{ dimension_unit_type{ 24 }, dimension_unit_type{ 42 } } };
                ...
                BOOST_AUTO_TEST_CASE(draw_on)
                {
                    ...
                    const note_header_type header{ string_type{ TETENGO2_TEXT("hoge") },
                                                   font_type::dialog_font(),
                                                   color_type{ 12, 34, 56 },
                                                   position_type{ position_unit_type{ 42 }, position_unit_type{ 24 } },
                                                   dimension_type{ dimension_unit_type{ 24 },
            ...
            BOOST_AUTO_TEST_SUITE(header)
                ...
                BOOST_AUTO_TEST_CASE(construction)
                {
                    ...
                    header_type                header1{ direction_type::down,
                                         model,
                                         message_catalog,
                                         *p_canvas,
                ...
                BOOST_AUTO_TEST_CASE(operator_assign)
                {
                    ...
                    header_type                header1{ direction_type::down,
                                         ...
                                         *p_canvas,
                                         dimension_type{ dimension_unit_type{ 42 }, dimension_unit_type{ 24 } },
                                         dimension_type{ dimension_unit_type{ 1 }, dimension_unit_type{ 1 } } };
                    header_type                header2{ direction_type::down,
                                         model,
                                         message_catalog,
                                         *p_canvas,
                                         dimension_type{ dimension_unit_type{ 42 }, dimension_unit_type{ 24 } },
                ...
                BOOST_AUTO_TEST_CASE(draw_on)
                {
                    ...
                    const picture_box_type     picture_box{ window, picture_box_type::scroll_bar_style_type::both };
                    const auto                 p_canvas = picture_box.create_canvas();
                    const header_type          header{ direction_type::down,
                                              model,
                                              message_catalog,
                                              *p_canvas,
                                              dimension_type{ dimension_unit_type{ 42 }, dimension_unit_type{ 24 } },
