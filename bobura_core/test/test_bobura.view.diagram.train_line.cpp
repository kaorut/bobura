            ...
            BOOST_AUTO_TEST_SUITE(train_line)
                ...
                BOOST_AUTO_TEST_CASE(construction)
                {
                    ...
                    const station_intervals_type station_intervals{
                        2, station_interval_calculator_type::default_interval()
                    };
                    const message_catalog_type message_catalog{};
                    train_line_type            train_line1{ train_type{ train_type::direction_type::down,
                                                             string_type{ TETENGO2_TEXT("number") },
                                                             0,
                                                             string_type{ TETENGO2_TEXT("name") },
                                                             string_type{ TETENGO2_TEXT("name_number") },
                ...
                BOOST_AUTO_TEST_CASE(operator_assign)
                {
                    ...
                    train_line_type            train_line1{ train_type{ train_type::direction_type::down,
                                                 ...
                                                 std::vector<position_unit_type>(2, position_unit_type{}),
                                                 message_catalog };
                    train_line_type            train_line2{ train_type{ train_type::direction_type::down,
                                                             string_type{ TETENGO2_TEXT("number") },
                                                             0,
                                                             string_type{ TETENGO2_TEXT("name") },
                                                             string_type{ TETENGO2_TEXT("name_number") },
