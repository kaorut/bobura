/*! \file
    \brief Test of class bobura::command::set_horizontal_scale.
...
namespace {
    ...
    using set_horizontal_scale_command_type = bobura::command::set_horizontal_scale<
...
BOOST_AUTO_TEST_SUITE(test_bobura)
    BOOST_AUTO_TEST_SUITE(command)
        BOOST_AUTO_TEST_SUITE(set_horizontal_scale)
            // test cases
            ...
            BOOST_AUTO_TEST_CASE(construction)
            {
                ...
                const set_horizontal_scale_command_type command{ diagram_view, scale_type{ 42 } };
            }
