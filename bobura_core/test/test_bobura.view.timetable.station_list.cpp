/*! \file
    \brief Test of class bobura::view::timetable::station_list.
...
namespace {
    ...
    using station_list_type = bobura::view::timetable::station_list<traits_type>;
}
...
BOOST_AUTO_TEST_SUITE(test_bobura)
    BOOST_AUTO_TEST_SUITE(view)
        BOOST_AUTO_TEST_SUITE(timetable)
            BOOST_AUTO_TEST_SUITE(station_list)
                // test cases
                ...
                BOOST_AUTO_TEST_CASE(construction)
                {
                    ...
                    station_list_type          header1{ direction_type::down,
                                               model,
                                               message_catalog,
                                               *p_canvas,
                                               dimension_type{ dimension_unit_type{ 42 }, dimension_unit_type{ 24 } } };
                    const station_list_type    header2{ std::move(header1) };
                }
                ...
                BOOST_AUTO_TEST_CASE(operator_assign)
                {
                    ...
                    station_list_type          header1{ direction_type::down,
                                               ...
                                               *p_canvas,
                                               dimension_type{ dimension_unit_type{ 42 }, dimension_unit_type{ 24 } } };
                    station_list_type          header2{ direction_type::down,
                                               model,
                                               message_catalog,
                                               *p_canvas,
                                               dimension_type{ dimension_unit_type{ 42 }, dimension_unit_type{ 24 } } };
                ...
                BOOST_AUTO_TEST_CASE(draw_on)
                {
                    ...
                    const picture_box_type     picture_box{ window, picture_box_type::scroll_bar_style_type::both };
                    const auto                 p_canvas = picture_box.create_canvas();
                    const station_list_type    station_list{ direction_type::down,
                                                          model,
                                                          message_catalog,
                                                          *p_canvas,
