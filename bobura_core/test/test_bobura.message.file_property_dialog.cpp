        ...
        BOOST_AUTO_TEST_SUITE(file_property_dialog)
            BOOST_AUTO_TEST_SUITE(ok_button_mouse_clicked)
                ...
                BOOST_AUTO_TEST_CASE(construction)
                {
                    ...
                    const bobura::message::file_property_dialog::ok_button_mouse_clicked<dialog_type> observer{
                        dialog
                    };
                }
            ...
            BOOST_AUTO_TEST_SUITE(cancel_button_mouse_clicked)
                ...
                BOOST_AUTO_TEST_CASE(construction)
                {
                    ...
                    window_type     parent{};
                    concrete_dialog dialog{ parent };
                    const bobura::message::file_property_dialog::cancel_button_mouse_clicked<dialog_type> observer{
                        dialog
                    };
                }
