...
namespace bobura {
    ...
    private:
        ...
        {
            auto p_button = std::make_unique<button_type>(m_base);
        ...
        {
            auto p_text_box = std::make_unique<text_box_type>(m_base, list_box_type::scroll_bar_style_type::none);
        ...
        {
            auto p_dropdown_box = std::make_unique<dropdown_box_type>(m_base);
        ...
        {
            auto p_picture_box = std::make_unique<picture_box_type>(m_base, list_box_type::scroll_bar_style_type::none);
    ...
    train_kind_dialog<Traits, Size, String, Font, PointDimensionUnit, Color, Canvas, FontDialog, ColorDialog>::
        train_kind_dialog(
            ...
            const color_type&           timetable_color,
            const message_catalog_type& message_catalog)
    : base_type{ parent }, m_p_impl{ std::make_unique<impl>(*this, background_color, timetable_color, message_catalog) }
    {}
