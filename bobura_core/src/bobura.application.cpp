...
namespace bobura {
    ...
    public:
        ...
        int run()
        {
            ...
            main_window.set_menu_bar(
                main_window_menu_builder_type(command_set_holder.command_set(), m_model, main_window, message_catalog)
                    .build());
    ...
    private:
        ...
        using view_station_selected_observer_type = message::diagram_view::station_selected<
            size_type,
            difference_type,
            string_type,
            position_type,
        ...
        using view_train_selected_observer_type = message::diagram_view::train_selected<
            size_type,
            difference_type,
            string_type,
            position_type,
        ...
        using view_all_unselected_observer_type = message::diagram_view::all_unselected<
            string_type,
            position_type,
            dimension_type,
            abstract_window_type,
        ...
        using main_window_window_resized_observer_type = message::main_window::window_resized<
            diagram_view_type,
            timetable_view_type,
            abstract_window_type,
            tab_frame_type,
        ...
        using diagram_view_picture_box_mouse_pressed_observer_type =
            message::view_picture_box::diagram::mouse_pressed<diagram_view_traits_type>;

        using diagram_view_picture_box_mouse_released_observer_type =
            message::view_picture_box::diagram::mouse_released<diagram_view_traits_type>;
        ...
        using diagram_view_picture_box_paint_paint_observer_type =
            message::view_picture_box::diagram::paint_paint<diagram_view_traits_type>;
        ...
        public:
            ...
            const command_set_type& command_set() const
            {
        ...
        void set_message_observers(
            ...
            const message_catalog_type& message_catalog)
        {
            m_model.observer_set().reset().connect(model_reset_observer_type{
                m_model, diagram_view, timetable_down_view, timetable_up_view, main_window });
            m_model.observer_set().changed().connect(model_changed_observer_type{
                m_model, diagram_view, timetable_down_view, timetable_up_view, main_window });
            ...
            main_window.size_observer_set().resized().connect(
                main_window_window_resized_observer_type{ diagram_view,
                                                          timetable_down_view,
                                                          timetable_up_view,
                                                          main_window,
        ...
        {
            picture_box.mouse_observer_set().pressed().connect(timetable_view_picture_box_mouse_pressed_observer_type{
                picture_box,
                [&picture_box](const mouse_button_type mouse_button) { picture_box.set_mouse_capture(mouse_button); },
                view });
            picture_box.mouse_observer_set().released().connect(timetable_view_picture_box_mouse_released_observer_type{
                [&picture_box](const mouse_button_type mouse_button) {
                    return picture_box.release_mouse_capture(mouse_button);
                },
                view });
    ...
    template <typename Traits>
    application<Traits>::~application() noexcept
    {}
