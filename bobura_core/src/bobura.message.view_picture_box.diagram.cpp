...
namespace bobura::message::view_picture_box::diagram {
    ...
    void mouse_moved<ViewTraits>::
         operator()(const position_type& position, const bool /*shift*/, const bool /*control*/, const bool /*meta*/) const
    {
        ...
        if (p_item)
        {
            ...
            {
                m_picture_box.set_cursor(std::make_unique<system_cursor_type>(system_cursor_type::style_type::hand));
            }
        }
        else
        {
    ...
    typename keyboard_key_down::scroll_bar_size_type keyboard_key_down::calculate_new_position(
        const typename picture_box_type::scroll_bar_type& scroll_bar,
    ...
    template <typename ViewTraits>
    void scroll_bar_scrolled<ViewTraits>::operator()(size_type /*new_position*/) const
    {
...
#if BOOST_COMP_MSVC
    template class mouse_pressed<typename application::traits_type_list_type::diagram_view_type>;

    template class mouse_released<typename application::traits_type_list_type::diagram_view_type>;

    template class mouse_moved<typename application::traits_type_list_type::diagram_view_type>;

    template class mouse_wheeled<typename application::traits_type_list_type::diagram_view_type>;

    template class paint_paint<typename application::traits_type_list_type::diagram_view_type>;

    template class scroll_bar_scrolled<typename application::traits_type_list_type::diagram_view_type>;
#endif

    template class mouse_pressed<typename test::traits_type_list_type::diagram_view_type>;

    template class mouse_released<typename test::traits_type_list_type::diagram_view_type>;

    template class mouse_moved<typename test::traits_type_list_type::diagram_view_type>;

    template class mouse_wheeled<typename test::traits_type_list_type::diagram_view_type>;

    template class paint_paint<typename test::traits_type_list_type::diagram_view_type>;

    template class scroll_bar_scrolled<typename test::traits_type_list_type::diagram_view_type>;
}