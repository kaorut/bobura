...
namespace bobura::command {
    ...
    public:
        ...
        using state_type = typename set_horizontal_scale::state_type;
    ...
    template <
        ...
        typename MainWindowTraits,
        typename DiagramViewTraits>
    set_horizontal_scale<Traits, Scale, CommandSetTraits, MainWindowTraits, DiagramViewTraits>::
        ~set_horizontal_scale() noexcept
    {}
    ...
    set_horizontal_scale<Traits, Scale, CommandSetTraits, MainWindowTraits, DiagramViewTraits>::state_impl() const
    {
