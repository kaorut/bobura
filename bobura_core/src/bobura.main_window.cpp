...
namespace bobura {
    ...
    private:
        ...
        void set_message_observers()
        {
            ...
            m_base.window_observer_set().closing().connect(main_window_window_closing_observer_type{
    ...
    template <typename Traits, typename CommandSetTraits>
    main_window<Traits, CommandSetTraits>::~main_window() noexcept
    {}
    ...
    main_window<Traits, CommandSetTraits>::get_tab_frame() const
    {
    ...
    main_window<Traits, CommandSetTraits>::get_diagram_view_picture_box() const
    {
    ...
    template <typename Traits, typename CommandSetTraits>
    const typename main_window<Traits, CommandSetTraits>::view_picture_box_type&
    main_window<Traits, CommandSetTraits>::get_timetable_down_view_picture_box() const
    {
    ...
    template <typename Traits, typename CommandSetTraits>
    const typename main_window<Traits, CommandSetTraits>::view_picture_box_type&
    main_window<Traits, CommandSetTraits>::get_timetable_up_view_picture_box() const
    {
    ...
    main_window<Traits, CommandSetTraits>::get_property_bar() const
    {
