...
namespace bobura::view {
    ...
    namespace {
        ...
        using application_model_type = timetable_model<
        ...
        using test_model_type = timetable_model<
    ...
    template const test_font_color_type& select_station_font_color<test_font_color_set_type, test_grade_type_set_type>(
