...
namespace bobura::load_save {
    ...
    private:
        ...
        using reader_selector_type = model::serializer::reader_selector<
            size_type,
            difference_type,
            string_type,
            iterator,
        ...
        using exec_json_reading_task_type = model::serializer::exec_json_reading_task<
            size_type,
            difference_type,
            string_type,
            operating_distance_type,
        ...
        using reader_set_type = model::serializer::reader_set<
            size_type,
            difference_type,
            string_type,
            iterator,
    ...
    template <typename Traits>
    load_from_file<Traits>::~load_from_file() noexcept
    {}
