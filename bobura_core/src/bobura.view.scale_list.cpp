...
namespace bobura { namespace view
{
    ...
    template <typename Size, typename String, typename Scale>
    typename scale_list<Size, String, Scale>::size_type scale_list<Size, String, Scale>::size()
    const
    {
    ...
    template <typename Size, typename String, typename Scale>
    const typename scale_list<Size, String, Scale>::scale_type& scale_list<Size, String, Scale>::at(
    ...
    template <typename Size, typename String, typename Scale>
    const typename scale_list<Size, String, Scale>::string_type& scale_list<Size, String, Scale>::label_at(
        const size_type index
    )
    const
    {
    ...
    template <typename Size, typename String, typename Scale>
    boost::optional<typename scale_list<Size, String, Scale>::size_type> scale_list<Size, String, Scale>::index_of(
    ...
    template <typename Size, typename String, typename Scale>
    const typename scale_list<Size, String, Scale>::scale_type& scale_list<Size, String, Scale>::larger(
        const scale_type& scale
    )
    const
    {
    ...
    template <typename Size, typename String, typename Scale>
    const typename scale_list<Size, String, Scale>::scale_type& scale_list<Size, String, Scale>::smaller(
        const scale_type& scale
    )
    const
    {
