        ...
        public:
            ...
            */
            void operator()() const
            {
                ...
                reset_timetable_scroll_bars(m_main_window.get_timetable_down_view_picture_box(), m_timetable_down_view);
                ...
                reset_timetable_scroll_bars(m_main_window.get_timetable_up_view_picture_box(), m_timetable_up_view);
