...
#pragma GCC diagnostic warning "-Wreturn-type"
        ...
        std::unique_ptr<timetable_type> read_impl(const iterator first, const iterator last, error_type& error)
        {
            const auto found = std::find_if(
                m_p_readers.begin(), m_p_readers.end(), [first, last](const std::unique_ptr<base_type>& p_reader) {
    ...
    : base_type{}, m_p_impl{ std::make_unique<impl>(std::move(p_readers)) }
    {}
    ...
    template <
        ...
        typename Speed,
        typename Font>
    reader_selector<Size, Difference, String, ForwardIterator, OperatingDistance, Speed, Font>::
        ~reader_selector() noexcept
    {}
    ...
    template <
        ...
        typename Font>
    std::unique_ptr<
        typename reader_selector<Size, Difference, String, ForwardIterator, OperatingDistance, Speed, Font>::
            timetable_type>
