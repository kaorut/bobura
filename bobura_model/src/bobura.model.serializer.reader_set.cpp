...
namespace bobura::model::serializer {
    ...
    class reader_set<
        ...
        Font,
        Utf8Encoder,
        Cp932Encoder>::impl : private boost::noncopyable
    {
    public:
        // types
        ...
        using json_reader_type = json_reader<
            size_type,
            difference_type,
            string_type,
            iterator,
        ...
        using bzip2_reader_type = bzip2_reader<
            size_type,
            difference_type,
            string_type,
            iterator,
        ...
        using oudia_reader_type = oudia_reader<
            size_type,
            difference_type,
            string_type,
            iterator,
        ...
        using windia_reader_type = windia_reader<
            size_type,
            difference_type,
            string_type,
            iterator,
        ...
        */
        static std::vector<std::unique_ptr<reader_type>>
        create_readers(abstract_window_type& parent, string_type file_name, const message_catalog_type& message_catalog)
        {
            std::vector<std::unique_ptr<reader_type>> readers{};

            readers.push_back(create_json_reader(parent, message_catalog));
            readers.push_back(std::make_unique<bzip2_reader_type>(create_json_reader(parent, message_catalog)));
            readers.push_back(create_oudia_reader(parent, std::move(file_name), message_catalog));
            readers.push_back(std::make_unique<windia_reader_type>());
    ...
    private:
        ...
        static std::unique_ptr<reader_type>
        create_json_reader(abstract_window_type& parent, const message_catalog_type& message_catalog)
        {
            auto p_exec_json_reading_task = std::make_unique<exec_json_reading_task_type>(parent, message_catalog);
            return std::make_unique<json_reader_type>(std::move(p_exec_json_reading_task));
        }
            ...
            const message_catalog_type& message_catalog)
        {
            auto p_select_oudia_diagram =
                std::make_unique<select_oudia_diagram_type>(parent, std::move(file_name), message_catalog);
            return std::make_unique<oudia_reader_type>(std::move(p_select_oudia_diagram));
        }
    ...
    template <
        ...
        typename Utf8Encoder,
        typename Cp932Encoder>
    std::vector<std::unique_ptr<typename reader_set<
        Size,
        Difference,
        String,
        ForwardIterator,
    ...
    namespace {
        ...
        namespace application {
            ...
            using select_oudia_diagram_type = select_oudia_diagram<oudia_diagram_dialog<
