...
namespace bobura::model {
    ...
    */
    ...
    public:
        ...
        */
            ...
            station_location_type                                 station_location)
        {
            ...
            std::for_each(m_up_trains.begin(), m_up_trains.end(), [offset](train_type& train) {
                insert_train_stop(train, offset);
            });
        ...
        */
        ...
        /*!
            ...
            \retval false Otherwise.
        */
        bool train_kind_referred(const typename train_kinds_type::const_iterator position) const
        {
        ...
        */
        void insert_train_kind(const typename train_kinds_type::const_iterator position, train_kind_type train_kind)
        {
        ...
        /*!
            ...
            \param train_kind A train kind.
        */
        void set_train_kind(const typename train_kinds_type::const_iterator position, train_kind_type train_kind)
        {
        ...
        */
            ...
            const typename train_type::stops_type::const_iterator& i_arrival) const
        {
            ...
            if (std::find_if(
                    m_down_trains.begin(),
                    m_down_trains.end(),
                    [&train](const train_type& t) { return &t == &train; }) == m_down_trains.end() &&
    ...
    private:
        ...
        static void
        erase_train_stops(train_type& train, const difference_type first_offset, const difference_type last_offset)
        {
        ...
        static void update_train_kind_index(train_type& train, const size_type index, const std::ptrdiff_t index_delta)
        {
            ...
            train_type new_train{ train.direction(), train.number(),      train.kind_index() + index_delta,
        ...
        bool can_insert_to(
            const typename station_locations_type::const_iterator position,
            const station_location_type&                          station_location) const
        {
        ...
        void
        insert_train_impl(trains_type& trains, const typename trains_type::const_iterator position, train_type train)
        {
