    ...
    BOOST_AUTO_TEST_SUITE(model)
        BOOST_AUTO_TEST_SUITE(train)
            ...
            BOOST_AUTO_TEST_CASE(construction)
            {
                ...
                {
                    const train_type train{ train_type::direction_type::up,
                                            string_type{ TETENGO2_TEXT("1") },
                                            0,
                                            string_type{ TETENGO2_TEXT("a") },
                                            string_type{ TETENGO2_TEXT("42") },
            ...
            BOOST_AUTO_TEST_CASE(operator_equal)
            {
                ...
                {
                    const train_type train1{ train_type::direction_type::down,
                                             string_type{ TETENGO2_TEXT("1") },
                                             0,
                                             string_type{ TETENGO2_TEXT("a") },
                                             string_type{ TETENGO2_TEXT("42") },
                ...
                }
                {
                    ...
                    const train_type train2{ train_type::direction_type::up,
                                             string_type{ TETENGO2_TEXT("1") },
                                             0,
                                             string_type{ TETENGO2_TEXT("a") },
                                             string_type{ TETENGO2_TEXT("42") },
...

                {
                    const train_type::stops_type stops{
                        stop_type{ time_type::uninitialized(),
                                   ...
                                   string_type{ TETENGO2_TEXT("a") } },
                        stop_type{
                            time_type::uninitialized(), time_type{ 2 }, false, string_type{ TETENGO2_TEXT("b") } },
                        stop_type{
                            time_type{ 3 }, time_type::uninitialized(), false, string_type{ TETENGO2_TEXT("c") } },
                        stop_type{ time_type::uninitialized(),
                                   time_type::uninitialized(),
                                   false,
                    ...
                    BOOST_CHECK(
                        train.previous_stop(std::next(train.stops().begin(), 2)) ==
                        std::next(train.stops().begin(), 1));
                    BOOST_CHECK(
                        train.previous_stop(std::next(train.stops().begin(), 3)) ==
                        std::next(train.stops().begin(), 2));
                }
                {
                    const train_type::stops_type stops{
                        stop_type{ time_type::uninitialized(),
                    ...
                    BOOST_CHECK(
                        ...
                        std::next(train.stops().begin(), 1));
                    BOOST_CHECK(
                        train.previous_stop(std::next(train.stops().begin(), 1)) ==
                        std::next(train.stops().begin(), 2));
            ...
            BOOST_AUTO_TEST_CASE(origin_stop)
            {
...

                {
                    const train_type::stops_type stops{
                        stop_type{
                            time_type::uninitialized(), time_type{ 0 }, false, string_type{ TETENGO2_TEXT("a") } },
                        ...
                        stop_type{
                            time_type{ 5 }, time_type::uninitialized(), false, string_type{ TETENGO2_TEXT("d") } },
                    };
