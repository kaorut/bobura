        ...
        BOOST_AUTO_TEST_SUITE(train_info)
            BOOST_AUTO_TEST_SUITE(stop)
                ...
                BOOST_AUTO_TEST_CASE(construction)
                {
                    ...
                    }
                    {
                        const stop_type stop{
                            time_type{ 1 }, time_type{ 2 }, true, string_type{ TETENGO2_TEXT("ZZZ") }
                        };
                ...
                BOOST_AUTO_TEST_CASE(operator_equal)
                {
...

                    {
                        const stop_type stop1{
                            time_type{ 1 }, time_type{ 2 }, false, string_type{ TETENGO2_TEXT("1") }
                        };
                    ...
                    }
                    {
                        ...
                        const stop_type stop2{
                            time_type{ 3 }, time_type{ 2 }, false, string_type{ TETENGO2_TEXT("1") }
                        };
                    ...
                    }
                    {
                        ...
                        const stop_type stop2{
                            time_type{ 1 }, time_type{ 4 }, false, string_type{ TETENGO2_TEXT("1") }
                        };
                    ...
                    }
                    {
                        ...
                        const stop_type stop2{
                            time_type{ 1 }, time_type{ 2 }, true, string_type{ TETENGO2_TEXT("1") }
                        };
                    ...
                    }
                    {
                        ...
                        const stop_type stop2{
                            time_type{ 1 }, time_type{ 2 }, false, string_type{ TETENGO2_TEXT("2") }
                        };
                    ...
                    }
                    {
                        ...
                        const stop_type stop2{
                            time_type{ 3 }, time_type{ 4 }, true, string_type{ TETENGO2_TEXT("2") }
                        };
                ...
                BOOST_AUTO_TEST_CASE(passing)
                {
                    ...
                    {
                        const stop_type stop{
                            time_type::uninitialized(), time_type{ 2 }, false, string_type{ TETENGO2_TEXT("1") }
                        };
                    ...
                    {
                        const stop_type stop{
                            time_type{ 1 }, time_type::uninitialized(), false, string_type{ TETENGO2_TEXT("1") }
                        };

                        BOOST_TEST(!stop.passing());
                    }
                    {
                        const stop_type stop{ time_type::uninitialized(),
