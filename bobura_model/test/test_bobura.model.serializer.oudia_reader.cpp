...
namespace {
    ...
    using reader_type = bobura::model::serializer::oudia_reader<
        size_type,
        difference_type,
        string_type,
                ...
                BOOST_AUTO_TEST_CASE(read)
                {
                    ...
                    }
                    {
                        ...
                        BOOST_TEST_REQUIRE(p_timetable->station_locations().size() == 6U);
                        {
                            ...
                            BOOST_CHECK(
                                station_location.get_station().grade().name() == string_type{ TETENGO2_TEXT("local") });
                        ...
                        }
                        {
                            ...
                            BOOST_CHECK(
                                station_location.get_station().grade().name() ==
