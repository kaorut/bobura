...
namespace {
    ...
    train_kind_type make_local_train_kind()
    {
        return train_kind_type{ string_type{ TETENGO2_TEXT("Local") },
                                string_type{ TETENGO2_TEXT("Local") },
                                font_type{ string_type{ TETENGO2_TEXT("hogefont") }, 42, false, false, false, true },
                                color_type{ 0, 0, 255 },
    ...
    train_kind_type make_rapid_train_kind()
    {
        return train_kind_type{ string_type{ TETENGO2_TEXT("Rapid") },
    ...
    train_kind_type make_express_train_kind()
    {
        return train_kind_type{ string_type{ TETENGO2_TEXT("Express") },
    ...
    train_kind_type make_limited_express_train_kind()
    {
        return train_kind_type{ string_type{ TETENGO2_TEXT("Limited Express") },
        ...
        BOOST_AUTO_TEST_SUITE(timetable)
            ...
            BOOST_AUTO_TEST_CASE(operator_equal)
            {
                ...
                }
                {
                    ...
                    timetable1.insert_station_location(
                        ...
                        station_location_type{ station_type{ string_type{ TETENGO2_TEXT("A") },
                                                             local_type::instance(),
                                                             false,
                                                             false,
                ...
                }
                {
                    ...
                    timetable2.insert_station_location(
                        timetable2.station_locations().end(),
                        station_location_type{ station_type{ string_type{ TETENGO2_TEXT("B") },
                                                             local_type::instance(),
                                                             false,
                                                             false,
                                                             string_type{ TETENGO2_TEXT("N") } },
            ...
            BOOST_AUTO_TEST_CASE(insert_station_location)
            {
                ...
                }
                {
                    ...
                    timetable.insert_station_location(
                        timetable.station_locations().end(),
                        station_location_type{ station_type{ string_type{ TETENGO2_TEXT("D") },
                                                             local_type::instance(),
                                                             false,
                                                             false,
                                                             string_type{ TETENGO2_TEXT("N") } },
                    ...
                    timetable.insert_station_location(
                        ...
                        station_location_type{ station_type{ string_type{ TETENGO2_TEXT("C") },
                                                             local_type::instance(),
                                                             false,
                                                             false,
                                                             string_type{ TETENGO2_TEXT("N") } },
                ...
                {
                    timetable_type timetable{};
                    timetable.insert_train_kind(timetable.train_kinds().end(), make_express_train_kind());

                    timetable.insert_down_train(
                        timetable.down_trains().end(),
                        train_type{ train_type::direction_type::down,
                    ...
                    BOOST_TEST_REQUIRE(
                        timetable.down_trains()[0].stops().size() == timetable.station_locations().size());
                    ...
                    BOOST_TEST_REQUIRE(
                        timetable.down_trains()[1].stops().size() == timetable.station_locations().size());
                    ...
                    BOOST_TEST_REQUIRE(
                        timetable.down_trains()[2].stops().size() == timetable.station_locations().size());
                ...
                }
                {
                    ...
                    timetable.insert_up_train(
                        ...
                        train_type{ train_type::direction_type::up,
                                    string_type{ TETENGO2_TEXT("1") },
                                    0,
                                    string_type{ TETENGO2_TEXT("a") },
                                    string_type{ TETENGO2_TEXT("42") },
            ...
            BOOST_AUTO_TEST_CASE(erase_station_locations)
            {
                ...
                }
                {
                    ...
                    BOOST_CHECK(
                        timetable.station_locations()[0].get_station().name() == string_type{ TETENGO2_TEXT("B") });
                ...
                }
                {
                    ...
                    BOOST_CHECK(
                        timetable.station_locations()[0].get_station().name() == string_type{ TETENGO2_TEXT("A") });
                    BOOST_TEST(timetable.station_locations()[0].operating_distance() == 1U);
                    BOOST_CHECK(
                        timetable.station_locations()[1].get_station().name() == string_type{ TETENGO2_TEXT("B") });
                ...
                }
                {
                    ...
                    BOOST_TEST(timetable.station_locations()[0].operating_distance() == 1U);
                    BOOST_CHECK(
                        timetable.station_locations()[1].get_station().name() == string_type{ TETENGO2_TEXT("C") });
            ...
            BOOST_AUTO_TEST_CASE(train_kind_referred)
            {
                ...
                {
                    timetable_type timetable{};
                    timetable.insert_train_kind(timetable.train_kinds().end(), make_local_train_kind());
                    timetable.insert_train_kind(timetable.train_kinds().end(), make_rapid_train_kind());
                    timetable.insert_train_kind(timetable.train_kinds().end(), make_express_train_kind());
            ...
            BOOST_AUTO_TEST_CASE(insert_train_kind)
            {
                ...
                const auto kind1 = make_local_train_kind();
            ...
            BOOST_AUTO_TEST_CASE(set_train_kind)
            {
                ...
                timetable.set_train_kind(timetable.train_kinds().begin(), make_limited_express_train_kind());
            ...
            BOOST_AUTO_TEST_CASE(erase_train_kind)
            {
                ...
                }
                {
                    ...
                    timetable.insert_train_kind(timetable.train_kinds().end(), make_local_train_kind());
                    timetable.insert_train_kind(timetable.train_kinds().end(), make_rapid_train_kind());
                    timetable.insert_train_kind(timetable.train_kinds().end(), make_limited_express_train_kind());
                ...
                }
                {
                    ...
                    BOOST_CHECK_THROW(
                        timetable.erase_train_kind(timetable.train_kinds().begin()), std::invalid_argument);
                }
            }
            ...
            BOOST_AUTO_TEST_CASE(assign_train_kinds)
            {
...

                {
                    ...
                    const train_kinds_type train_kinds{ make_local_train_kind(), make_rapid_train_kind() };
            ...
            BOOST_AUTO_TEST_CASE(erase_down_trains)
            {
                ...
                }
                {
                    ...
                    timetable.erase_down_trains(
                        timetable.down_trains().begin() + 1, timetable.down_trains().begin() + 2);
            ...
            BOOST_AUTO_TEST_CASE(scheduled_speed)
            {
                ...
                {
                    train_type train{ train_type{ train_type::direction_type::down,
                                                  string_type{ TETENGO2_TEXT("1") },
                                                  0,
                                                  string_type{ TETENGO2_TEXT("a") },
                                                  string_type{ TETENGO2_TEXT("42") },
                    ...
                    train.insert_stop(
                        train.stops().end(),
                        stop_type{ time_type::uninitialized(),
                ...
                {
                    train_type train{ train_type{ train_type::direction_type::up,
                                                  string_type{ TETENGO2_TEXT("2") },
                                                  0,
                ...
                {
                    const auto speed = timetable.scheduled_speed(
            ...
            BOOST_AUTO_TEST_CASE(set_font_color_set)
            {
                ...
                const font_color_type     font_color{ std::move(diagram_font),
                                                  std::move(diagram_color),
                                                  std::move(timetable_font),
                                                  std::move(timetable_color) };
                const font_color_set_type font_color_set{ font_color, font_color, font_color, font_color, font_color,
